...
import top.itning.smpandroidteacher.entity.LoginUser;
import top.itning.smpandroidteacher.entity.Role;
import top.itning.smpandroidteacher.ui.view.CustomVideoView;
import top.itning.smpandroidteacher.util.UserUtils;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void doLogin(@Nullable String token) {
        ...
        if (loginUserOptional.isPresent()) {
            ...
            if (loginUser.getRole().getId().equals(Role.TEACHER_ROLE_ID)) {
                ...
                Toast.makeText(this, "请使用教师账户进行登录", Toast.LENGTH_LONG).show();
            }
        } else {
